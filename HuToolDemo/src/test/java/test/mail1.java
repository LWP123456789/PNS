...
public class mail1 {
    public static void main(String[] args) throws Exception {
        ...
        ts.connect("smtp.qq.com", "3022422894@qq.com", "brsrxrunyqmxdeje");
        // 创建邮件
    ...
    public static MimeMessage createSimpleMail(Session session) throws Exception {
        ...
        // 指明邮件的发件人
        message.setFrom(new InternetAddress("3022422894@qq.com"));
        // 指明邮件的收件人，发件人和收件人如果是一样的，那就是自己给自己发
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("1912020064@henu.edu.cn"));
        // 邮件的标题
